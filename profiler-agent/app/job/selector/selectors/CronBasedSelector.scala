...
object CronBasedSelector {
  ...
  def apply(assetSelectorDefinition: AssetSelectorDefinition,
            ...
            submitter: AssetSubmitter, system: ActorSystem, configuration: Configuration): Future[CronBasedSelector] = {
...
class CronSelectorJob extends Job {
  ...
  override def execute(context: JobExecutionContext): Unit = {
    ...
    val jobFuture = (for (
      source <- cronSelector.sourceProvider.get(cronSelector.sourceDefinition);
