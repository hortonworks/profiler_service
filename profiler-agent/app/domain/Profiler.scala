...
case class Profiler(val id: Option[Long], name: String,
                    ...
                    , metaManagementSchema: Option[ProfilerMetaConfiguration]
                    , dryRunSchema: Option[DryRunSchemaForProfiler])
...
case class SelectorConfig(name: String, config: JsObject)

case class ProfilerInstanceAndSelectorConfig(profilerInstance: ProfilerInstance, selectorConfig: SelectorConfig)

case class ProfilerInstanceAndSelectorDefinition(profilerInstance: ProfilerInstance, selectorDefinition: AssetSelectorDefinition)
