...
import profilers.dryrun.models.DryRunOutPutStatus.DryRunOutPutStatus
import profilers.dryrun.models.{Cause, DryRunOutPutSchema, DryRunOutPutStatus}

object DryRunOutPutParser {
  ...
  implicit val causeFormat: Format[Cause] =
    Json.format[Cause]
