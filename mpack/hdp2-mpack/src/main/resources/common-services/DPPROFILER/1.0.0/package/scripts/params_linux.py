...
dpprofiler_home = format('{stack_root}/current/{dpprofiler_root}/hdp2')
...
dpprofiler_credential_provider_hdfs_path = format("jceks://hdfs{dpprofiler_profiler_hdfs_dir}/security/dpprofiler-config.jceks")
...
livy_session_config_read_heartbeatTimeoutInSecond = dpprofiler_livy_config["livy.session.config.read.heartbeatTimeoutInSecond"]
...
livy_session_config_write_heartbeatTimeoutInSecond = dpprofiler_livy_config["livy.session.config.write.heartbeatTimeoutInSecond"]
