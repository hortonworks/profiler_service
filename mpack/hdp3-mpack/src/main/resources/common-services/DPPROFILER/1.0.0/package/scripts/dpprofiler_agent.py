  ...
  def start(self, env, upgrade_type=None):
    ...
    if params.credential_store_enabled:
      if 'hadoop.security.credential.provider.path' in params.dpprofiler_config:
        ...
        credential_provider_hdfs_src_path = params.dpprofiler_credential_provider_hdfs_path[len('jceks://hdfs'):]
        ...
        Logger.error("hadoop.security.credential.provider.path property not found in dpprofiler-env config-type")
